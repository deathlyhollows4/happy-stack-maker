...
import { reviewCode, submitPracticeAttempt } from "@/lib/codewise.functions";
import {
  recordPracticeEvent,
...
interface PracticeRunCodeResult {
  ok: boolean;
  error?: string;
  stdout?: string;
  stderr?: string;
  ...
  testResults?: PracticeRunOutput["testResults"];
  testSummary?: PracticeRunOutput["testSummary"];
}
