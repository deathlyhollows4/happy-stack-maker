...
This project is indexed by GitNexus as **happy-stack-maker** (2564 symbols, 3814 relationships, 117 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
