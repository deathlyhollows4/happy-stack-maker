...
- Name: critical-path.spec.ts >> Critical Path E2E >> practice page â€” redirects unauthenticated users
- Location: tests\e2e\critical-path.spec.ts:75:3
...
Expected pattern: not /\/practice$/
Received string: "http://localhost:3001/practice"
Timeout: 5000ms

Call log:
  - Expect "not toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:3001/practice"
